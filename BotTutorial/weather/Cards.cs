...
public static class Cards
{
    public static Attachment CreateAdaptiveCardAttachment()
    {
        ...
        var paths = new[] { ".", "Resources", "FlightItineraryCard.json" };
    ...
    public static HeroCard GetHeroCard()
    {
        var heroCard = new HeroCard
        {
            ...
            Images = new List<CardImage> { new CardImage("https://docs.microsoft.com/en-us/azure/bot-service/media/how-it-works/architecture-resize.png") },
